...
//return '32323';
	...
	{
		//echo Input::get('bill_ids');
		$bills = array();
		$print_vouchar = array();
		$print = Input::get('print');
		$fthername = array();
		$ids = Input::get('bill_ids');
		if(Input::get('bill_ids')!==''){

			$bills = explode(',', Input::get('bill_ids'));
			$print = Input::get('print');
...
//echo "<pre>";print_r($totals );exit;
	...
	public function family_voucherprint($family_id,$billno)
	{
		$bills = array();
		$print_vouchar = array();
		$print = Input::get('print');
	...
	public function family_vouchar_paid($id)
	{
		...
		if(Input::get('s')!='unpaid'){
	      ...
	      //return Redirect::to('/family/vouchar_history/'.$family_vouchers->family_id.'?print=yes&bill_ids='. Input::get('bills'))->with('success','voucher paid');
	  	}else{
	  	    return Redirect::to('/family/vouchar_history/'.$family_vouchers->family_id)->with('success','voucher paid');
