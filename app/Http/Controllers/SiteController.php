...
class SiteController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('app.site.dashboard', compact(
            'subscribers',
            'photos',
            'events',
            'googleToken',
    ...
    public function aboutContent(Request $request)
    {
        ...
        return view('app.site.home.about.content', compact('content', 'images'));
    }
  ...
  /**
    ...
    public function aboutContentImage(Request $request)
    {
        ...
        return view('app.site.home.about.image', compact('images'));
    }
    ...
    public function serviceContent(Request $request)
    {
        ...
        return view('app.site.home.service', compact('content'));
    }
    ...
    public function statisticContent(Request $request)
    {
        ...
        return view('app.site.home.statistic', compact('content'));
    }
    ...
    public function testimonialIndex(Request $request)
    {
        ...
        return view('app.site.home.testimonial.list', compact('testimonials'));
    }
    ...
    public function testimonialCreate(Request $request)
    {
        ...
        return view('app.site.home.testimonial.add', compact('testimonials'));
    }
    ...
    public function subscribe(Request $request)
    {
        ...
        return view('app.site.home.subscribers', compact('subscribers'));
    }
    ...
    public function gallery()
    {
        ...
        return view('app.site.gallery.content', compact('images'));
    }
    /**
    ...
    public function galleryAdd(Request $request)
    {
        ...
        return view('app.site.gallery.image');
    }
    ...
    public function contactUs(Request $request)
    {
        ...
        return view('app.site.contact_us', compact('address', 'phone', 'email', 'latlong'));
    }
    ...
    public function faq(Request $request)
    {
        ...
        return view('app.site.faq', compact('faqs'));
    }
    ...
    public function timeline(Request $request)
    {
        ...
        return view('app.site.timeline', compact('timeline'));
    }
    ...
    public function settings(Request $request)
    {
        ...
        return view('app.site.settings', compact('info'));
    }
    ...
    public function analytics(Request $request)
    {
        ...
        return view('app.site.analytics', compact('info'));
    }
