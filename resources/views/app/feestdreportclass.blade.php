        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form role="form" id="defulter" name="defulter" action="{{ url('/fees/classreport') }}"
        ...
        */
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="hidden" id="session" required="true" class="form-control datepicker2" name="session"
                    data-date-format="yyyy" value="{{ get_current_session()->id }}">
        ...
        <form action="{{ url('/fees/unpaid_notification') }}" method="post">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <button class="btn btn-primary pull-right" id="btnsave" type="submit"><i
                                class="glyphicon glyphicon-th"></i> Send Notification to Unpaid </button>
                        ...
                        @if ($resultArray != '')
                            @foreach ($resultArray as $fee)
                                <tr>
                                    ...
                                    <td>
                                        @if ($fee['status'] == 'Paid')
                                            <span class="role paid">{{ $fee['status'] }}</span>
                                        @elseif($fee['status'] == 'Adjust')
                                            <span class="btn btn-primary">{{ $fee['status'] }}</span>
                                        @else
                                            <span class="role unpaid">{{ $fee['status'] }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($fee['status'] == 'Paid' || $fee['status'] == 'Adjust')
                                            {{ $fee['payDate'] }}
                                        @else
                                        @endif
                                    </td>
