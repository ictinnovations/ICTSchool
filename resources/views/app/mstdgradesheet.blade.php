    ...
    <div class="resHdr">
        ...
        <div class="schoolIdentity">
            ...
            <div class="hdrText hdr-result">
                <h2>{{$student->firstName}} {{$student->middleName}} {{$student->lastName}} Report Card</h2>
                <div style="width:115px;margin:0 auto;"><hr></div>
                <h4>{{$extra[0]}}-{{$student->session}}</h4>
            </div><!-- end of hdrText -->
        ...
        <div class="resTophdr">
            <div class="restopleft">
                <table class="std-information" style="float:left">
                	<tr><td class="left">FATHER NAME :</td><td class="right">{{$student->fatherName}}</td></tr>
                	<tr><td class="left">CLASS : </td><td class="right">{{$student->class}}</td></tr>
                	<tr><td class="left">Section : </td><td class="right"> {{$student->section_name}}</td></tr>
                	<tr><td class="left">Registartion Number:</td><td class="right"> {{$student->regiNo}}</td></tr>
                </table>
            </div><!-- end of restopleft -->

            <div class="restopright rgttopright">
                <table class="std-information" style="float:right">
                        <tr><td>&nbsp;	</td><td>&nbsp;	</td></tr>
                	<tr><td class="left">GRADE</td><td class="right">{{$meritdata->grade}}</td></tr>
                	<tr><td class="left">POSITION</td><td class="right">{{$meritdata->position}}TH</td></tr>
                	<tr><td class="left">GPA</td><td class="right">{{$meritdata->point}}</td></tr>
                </table>
            </div><!-- end of restopleft -->
