                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <button class="btn btn-primary pull-right" name="action" value="voice"
                                                id="btnsave"
                                                onclick="return confirm('Are you sure you want to send notification?');"
                                                type="submit"><i class="glyphicon glyphicon-th"></i> Send voice
                                                Notification </button>


                                        </div>
                                        <div class="input-group"
                                            style="margin-top: -38px;/* margin-bottom: -178px; */margin-left: 210px;">
                                            <button class="btn btn-primary pull-right" name='action' value='sms'
                                                id="btnsave"
                                                onclick="return confirm('Are you sure you want to send notification?');"
                                                type="submit"><i class="glyphicon glyphicon-th"></i> Send Sms Notification
                                            </button>
                                            ...
                                            <tr>
                                              ...
                                              */
                                                    ...
                                                    @if ($statusn == 'Paid' || $statusn == 'paid')
                                                        ...
                                                        if ($atd->status == 'adjust') {
                                                            $status = 'adjust';
                                                        } elseif ($atd->payableAmount === $atd->paidAmount || $atd->paidAmount >= $atd->payableAmount) {
                                                            $status = 'paid';
        ...
        $(document).ready(function() {
            ...
            $("#btnPrint").click(function() {
                ...
                if (aclass != "" && section != "" && shift != "" && session != "" && atedate != "") {
                    ...
                    var exurl = "{{ url('/attendance/printlist') }}" + '/' + aclass + '/' + section + '/' +
                        shift + '/' + session + '/' + atedate;
