...
<head>
    <style>
        ...
        @media print {
            ...
            /* Hide the URL and other browser-added content */
            a::after {
                content: "" !important;
                /* Remove URL after links */
            }

            /* Ensure no extra elements are printed */
            .no-print {
                display: none;
    ...
    <div class="main-vouchar">
        @for ($i = 0; $i < 3; $i++)
            <div class="@if ($i == 1 || $i == 2) doted @endif vouchar ">
                ...
                <img src="{{ asset('markssheetcontent/school-title.png') }}" alt="School Title">
                <h2> </h2>
