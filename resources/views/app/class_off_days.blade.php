        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form role="form" action="{{ url('') }}/class-off/store" method="post"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control datepicker" name="offDate"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group ">
                                            <label for="holiDateTo">Date End <span
                                                    class="text-danger">[Optional]</span></label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i>
                                                </span>
                                                <input type="text" class="form-control datepicker" name="offDateEnd"
                                ...
                                <table id="offdayList" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($offdays as $day)
                                            <tr>
                                                <td>{{ date('j M, Y', strtotime($day->offDate)) }}</td>
                                                <td>
                                                    @if ($day->oType == 'E')
                                                        Exam
                                                    @elseif($day->oType == 'O')
                                                ...
                                                <td>{{ date('d/m/Y h:i:s a', strtotime($day->created_at)) }}</td>
                                                <td>
                                                    <a title='Delete' class='btn btn-danger'
                                                        href='{{ url('/class-off/delete') }}/{{ $day->id }}'> <i
