            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    @endif
                        ...
                        <form role="form" action="{{route('year.create')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="from" required="true"  name="title" value="" placeholder="Enter Title">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="checkbox" class="form-control"  name="default">
