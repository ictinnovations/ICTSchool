...
@section('content')
    @if (Session::get('success'))
        <div class="alert alert-success">
            ...
            <strong>Process Success.</strong> {{ Session::get('success') }}<br><a href="{{ url('/fees/view') }}">View List</a><br>
        </div>
    @endif
    @if (count($errors) > 0)
                                            ...
                                            <select id="class" id="class" name="class" class="form-control">
                                                @foreach ($classes as $class)
                                                    <option value="{{ $class->code }}"
                                                        @if ($class1 == $class->code) Selected @endif>
                                                        {{ $class->name }}</option>
                                                @endforeach
                                            ...
                                            <select id="section" name="section" class="form-control">
                                                @if (!empty($sections))
                                                    @foreach ($sections as $sction)
                                                        <option value="{{ $sction->id }}"
                                                            @if ($section == $sction->id) selected @endif>
                                                            {{ $sction->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                ...
                <div class="form-group ">
                  ...
                  <div class="input-group">
                    ...
                    <input value="{{date('Y')}}" type="text" id="session" required="true" class="form-control datepicker2" name="session"   data-date-format="yyyy">
                                ...
                                <input value="{{ get_current_session()->id }}" type="hidden" id="session" required="true"
                                    class="form-control " name="session" data-date-format="yyyy">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select id="type" name="type" class="form-control" required>
                                                    ...
                                                    <option value="Other"
                                                        @if ($type == 'Other') Selected @endif>Other</option>
                                                    <option value="Monthly"
                                                        @if ($type == 'Monthly') Selected @endif Selected>Monthly
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select id="month" name="month" class="form-control"
                                                    ...
                                                    <option value="1"
                                                        @if ($month == '1') selected @endif>January</option>
                                                    <option value="2"
                                                        @if ($month == '2') selected @endif>February</option>
                                                    <option value="3"
                                                    ...
                                                    <option value="8"
                                                        @if ($month == '8') selected @endif>August</option>
                                                    <option value="9"
                                                        @if ($month == '9') selected @endif>September
                                                    </option>
                                                    <option value="10"
                                                        @if ($month == '10') selected @endif>October</option>
                                                    <option value="11"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select id="student" name="student" class="form-control "
                                                    ...
                                                    @if ($student)
                                                        ...
                                                        <option value="{{ $student->regiNo }}">{{ $student->firstName }}
                                                            {{ $student->lastName }} [{{ $student->rollNo }}]</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="glyphicon glyphicon-info-sign blue"></i></span>
                                                    <input id="total_fee" type="text" class="form-control"
                                                        readonly="true" name="total_fee" placeholder="0.00">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="glyphicon glyphicon-info-sign blue"></i></span>
                                                    <input id="feeAmount" type="text" class="form-control"
                                                        readonly="true" name="feeAmount" placeholder="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="LateFeeAmount">Late Fee Fine( <i id="LateFeeAmount1"> </i>
                                                    )</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="glyphicon glyphicon-info-sign blue"></i></span>
                                                    <input id="LateFeeAmount" type="text" class="form-control"
                                                        name="LateFeeAmount" value="0.00" placeholder="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>&nbsp;</label>
                                                <div class="input-group">
                                                    <button type="button" class="btn btn-primary" id="btnAddRow"><i
                                                            class="glyphicon glyphicon-plus"></i> Add Fee</button>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-danger" id="btnDeleteRow"><i
                                                            class="glyphicon glyphicon-trash"></i> Remove Fee</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="ctotal"
                                                        readOnly="true" name="ctotal" value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="previousdue"
                                                        readOnly="true" name="previousdue" value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="gtotal"
                                                        readOnly="true" name="gtotal" value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="display:none">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" min='0' class="form-control"
                                                        id="paidamount" required="true" name="paidamount"
                                                        value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" min='0' class="form-control"
                                                        id="ctotal1" required="true" name="paidamount" value="0.00"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="dueamount"
                                                        readOnly="true" name="dueamount" value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <br>
                                                <div class="col-md-6"><button class="btn btn-primary" id="btnsave1"
                                                        name='save_sms' value="save_sms" type="submit"><i
                                                            class="glyphicon glyphicon-plus"></i>Save and SMS</button>
                                                    <button class="btn btn-primary pull-right" id="btnsave"
                                                        name='only_save' value="only_save" type="submit"><i
                                                            class="glyphicon glyphicon-plus"></i>Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    @section('script')
        ...
        */
            ...
            var getStudents = function() {
                ...
                if (section != '') {
                    $.ajax({
                        url: "{{ url('/student/getList') }}" + '/' + aclass + '/' + section + '/' + shift + '/' +
                            session,
                        data: {
                            format: 'json'
                        },
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(i, student) {
                                ...
                                $('#student').append($('<option>').text(student.firstName + " " +
                                    student.middleName + " " + student.lastName + "[" + student
                                    .rollNo + "]").attr('value', student.regiNo));
            ...
            $(document).ready(function() {
                ...
                $('#type').change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#fee').empty();
                            $('#fee').append($('<option>').text("--Select Fee--").attr('value',
                                "-1"));
                            $.each(data, function(i, fee) {
                                // console.log(fee);

                                $('#fee').append($('<option>').text(fee.title).attr('value',
                                    fee.id));
                            });
                            //console.log(data);
                        },
