...
@section('content')
    @if (Session::get('success'))
        <div class="alert alert-success">
            ...
            <strong>Process Success.</strong> {{ Session::get('success') }}<br><a href={{ url('/subject/list') }}>View
                List</a><br>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('code') }}" autofocus
                                                required name="code" placeholder="Subject Code">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="type" class="form-control" required>
                                                <option value="Core"
                                                    @if (old('type') == 'Core') selected @else selected @endif>Core
                                                </option>
                                                <option value="Comprehensive"
                                                    @if (old('type') == 'Comprehensive') selected @endif>Comprehensive</option>
                                                <option value="Electives" @if (old('type') == 'Electives') selected @endif>
                                                    Electives</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="subgroup" class="form-control" required>
                                                ...
                                                <option value="Bangla" @if (old('subgroup') == 'Bangla') selected @endif>
                                                    Urdu</option>
                                                <option value="English" @if (old('subgroup') == 'English') selected @endif>
                                                    English</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="stdgroup" class="form-control" required>
                                                ...
                                                <option value="Science" @if (old('stdgroup') == 'Science') selected @endif>
                                                    Science</option>
                                                <option value="Arts" @if (old('stdgroup') == 'Arts') selected @endif>
                                                    Arts</option>
                                                <option value="Commerce" @if (old('stdgroup') == 'Commerce') selected @endif>
                                                    Commerce</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="class[]" class="form-control selectpicker" multiple
                                                data-hide-disabled="true" data-size="5"required>
                                                @foreach ($classes as $class)
                                                    <option value="{{ $class->code }}"
                                                        @if (old('class.*') == $class->code) selected @endif>
                                                        {{ $class->name }}</option>
                                                @endforeach
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="wfull" value="0"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" required name="wpass"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="mfull" value="0"
                                                    required="true" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" required name="mpass"
                                                    value="0" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="sfull" value="0"
                                                    required="true" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" required name="spass"
                                                    value="0" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="pfull" value="0"
                                                    required="true" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="ppass" value="0"
                                                    placeholder="0">
                                            </div>
                                        </div>
                                    </div>
