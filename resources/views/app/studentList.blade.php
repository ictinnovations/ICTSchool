...
@section('content')
    ...
    <div class="row">
        <div class="box col-md-12">
            <a href="{{ url('/student/create') }}" style=" margin-left:85%;margin-top: -40px;"
                class="btn btn-info btn-lg">Add Student</a>
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form role="form" action="{{ url('/student/list') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" id="session" class="form-control datepicker2" name="session"
                                            value="{{ get_current_session()->id }}">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {!! Form::select('class', $classes, $formdata->class, [
                                                        'class' => 'form-control',
                                                        'id' => 'class',
                                                        'required' => 'true',
                                                    ]) !!}
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {!! Form::select('section', $data, $formdata->section, [
                                                        'class' => 'form-control',
                                                        'id' => 'section',
                                                        'required' => 'true',
                                                    ]) !!}
                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td> {!! '<b> Father:</b> ' .
                                                ...
                                                $student->localGuardianCell !!}</td>
                                            <td>{{ $student->presentAddress }}</td>
                                            <td><a class='btn btn-success'
                                                    href="{{ url('/family/students') }}/{{ $student->family_id }}">{{ $student->family_id }}</a>
                                            </td>
                                            <td>
                                                <a title='View' class='btn btn-success'
                                                    href='{{ url('/student/view') }}/{{ $student->id }}'> <i
                                                        class="glyphicon glyphicon-zoom-in icon-white"></i></a>&nbsp&nbsp<a
                                                    title='Edit' class='btn btn-info'
                                                    href='{{ url('/student/edit') }}/{{ $student->id }}'> <i
                                                        class="glyphicon glyphicon-edit icon-white"></i></a>
                                                &nbsp&nbsp<a title='Delete' class='btn btn-danger' href='#'
                                                    onclick="confirmed('{{ $student->id }}')"> <i
                                                        class="glyphicon glyphicon-trash icon-white"></i></a>
                                                &nbsp&nbsp <a title='View' class='btn btn-success'
                                                    href='{{ url('/student/access') }}/{{ $student->id }}'> <i
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, section) {
                        ...
                        var opt = "<option value='" + section.id + "'>" + section.name + ' (  ' +
                            section.students + ' ) ' + "</option>"
