        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form role="form" action="{{ url('/accounting/expencecreate') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" required
                                                        name="name[{{ $sector->id }}]" value="{{ $sector->name }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="amount[{{ $sector->id }}]" placeholder="0.00">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ date('d/m/Y') }}"
                                                        class="form-control datepicker" name="date[{{ $sector->id }}]"
