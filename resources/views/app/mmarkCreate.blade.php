...
@section('content')
    @if (Session::get('success'))
        <div class="alert alert-success">
            ...
            <strong>Process Success.</strong> {{ Session::get('success') }}<br><a href="{{ url('/mark/list') }}">View List</a><br>
                                                        ...
                                                        <select id="class" name="class" class="form-control">
                                                            ...
                                                            @foreach ($classes as $class)
                                                                <option value="{{ $class->code }}"
                                                                    @if ($class_code == $class->code) selected @endif>
                                                                    {{ $class->name }}</option>
                                                            @endforeach
                         ...
                         <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                            <input type="text" id="session" required="true" class="form-control datepicker2" name="session" value="{{$session}}"  data-date-format="yyyy">
                                            ...
                                            <input type="hidden" id="session" required="true"
                                                class="form-control datepicker2" name="session" value="{{ $session }}"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#subject").change(function() {
                ...
                $.ajax({
                    url: "{{ url('/subject/getmarks') }}" + '/' + $('#subject').val() + '/' + $(
                        '#class').val(),
                    data: {
                        format: 'json'
                    },
            ...
            $.ajax({
                ...
                success: function(json) {
                    ...
                    $.each(json, function(i, subject) {
                        ...
                        $('#subject').append($('<option>').text(subject.name).attr('value', subject
                            .code));
                    });
                }
            });
