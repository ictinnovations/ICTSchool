        ...
        <div class="box-inner">
            ...
            <div class="box-content">
              @if (count($errors) > 0)
                    ...
                    @endif
                    @if (isset($marks))
                   <form role="form" action="{{url('/mark/m_update')}}" method="post">
		   ...
		   <input type="hidden" name="subject" value="{{$marks->subject }}">
		    <input type="hidden" name="class" value="{{$marks->class }}">
                 ...
                 <div class="col-md-12">
                   <div class="col-md-2">
                     <div class="form-group">
                         <label for="written">Obtain Marks</label>
                         <div class="input-group">
                             <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                             <input type="text" class="form-control" required="true"  name="written" value="{{$marks->obtain_marks}}">
                         </div>
                     </div>
                   </div>
                   <div class="col-md-2">
                     <div class="form-group">
                         <label for="mcq">Total Marks</label>
                         <div class="input-group">
                             <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                             <input type="text" class="form-control" required="true"  name="total_marks" value="{{$marks->total_marks}}">
                         </div>
                     </div>
                   </div>
