  ...
  <div class="box col-md-12">
    <div class="box-inner">
      ...
      <div class="box-content">
        ...
        <form role="form" action="{{url('/fee/voucher')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select id="class" id="class" name="class" class="form-control" disabled>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select id="student" name="student" class="form-control selectpicker" required="true"  data-show-subtext="true" data-live-search="true" disabled>
                     @if($student)
                     <!--<option value='-1'>---Select Student---</option>-->
                     <option value="{{$student->regiNo}}">{{$student->firstName}} {{$student->lastName}} [{{$student->rollNo}}]</option>
                    @endif
                    </select>
                    <input type="hidden" name="student" id="student1" value="{{$student->regiNo}}">
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <button class="btn btn-primary pull-right" id="btnsave" type="submit"><i class="glyphicon glyphicon-plus"></i>Create Vouchar</button>
                </div>
              </div>
            </div>
    ...
    <script type="text/javascript">
     ...
     $('#type').change(function() {
      ...
      $("#student").on('change',function(){
        //alert(<?php echo $student->regiNo ?>);
       // alert(34);
        var student_reg = $("#student").val();
        var ids = $('#fee').val();

        //alert($( '#fee :selected' ).val());
        //alert(ids);
        $('#feeInfoDiv').show();
       // alert(ids);
       /* if ((ids!="-1" && $('#type').val()=="Monthly") || $('#type').val()=="Other")
        {
        $('#feeInfoDiv').show();
