...
<div class="box col-md-12">
        <div class="box-inner">
            <div data-original-title="" class="box-header well">
                <h2><i class="glyphicon glyphicon-home"></i> Diary Update</h2>

            </div>
            <div class="box-content">
              <form role="form" action="{{url('/teacher/diary/update')}}" method="post">
                            ...
                            <div class="input-group">
                                ...
                                <select name="class" id="class" required class="form-control">
                                    ...
                                    @foreach($teachers_class as $class)
                                      <option value="{{$class->code}}" @if($diary->class==$class->code) selected @endif>{{$class->name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
