        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form role="form" action="{{ url('/holidays/create') }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" required class="form-control datepicker" name="holiDate"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="holiDateEnd"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign"></i>
                                            </span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">&nbsp;</label>
                                        <div>
                                            <button class="btn btn-primary pull-left" type="submit"><i
                        ...
                        <table id="holidayList" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($holidays as $day)
                                    <tr>
                                        <td>{{ date('j M, Y', strtotime($day->holiDate)) }}</td>
                                        <td>{{ $day->description }}</td>
                                        <td>{{ date('d/m/Y h:i:s a', strtotime($day->createdAt)) }}</td>
                                        <td>
                                            <a title='Delete' class='btn btn-danger'
                                                href='{{ url('/holidays/delete') }}/{{ $day->id }}'> <i
